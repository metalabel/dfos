...
Non-normative: ask-time key proof may eventually be preferred for every client — including `scope=identity` — as self-custodied client tooling matures; this tier is the seam such a rule would generalize from.
