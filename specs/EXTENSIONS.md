...
| `DfosDocumentGateway`     | [DOCUMENT-GATEWAY](https://protocol.dfos.com/document-gateway#discovery)                                 | consumer   | Base URL of a document gateway serving this identity's content.                                                                        |
| `DfosProfile`             | [DOCUMENT-GATEWAY](https://protocol.dfos.com/document-gateway#discovery)                                 | consumer   | The identity's profile document — a contentId (living chain) or artifact CID (immutable snapshot), dispatched by shape as anchors are. |
