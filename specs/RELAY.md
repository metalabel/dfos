...
A relay MAY serve an [OpenAPI](https://spec.openapis.org/oas/latest.html)
...
2. Standing authorization backed by that credential stops granting: the live
   per-request check denies it on the next read.
...
surfaces a peer's 400 cursor rejection as a distinguishable **invalid-cursor**
