...
export const faqs: FaqEntry[] = [
  ...
  },
  {
    ...
    answer:
      'explore.dfos.com is a chain explorer that runs entirely in the browser tab. It reads from relays but trusts none of them: every operation it displays is re-verified client-side, with CIDs re-derived, signatures re-checked, and the chain re-folded, so what you see is what your own browser proved rather than what a relay asserted. The explorer is MIT-licensed and in this repository; it is deployed rather than published to npm.',
    answerHtml:
      '<a href="https://explore.dfos.com">explore.dfos.com</a> is a chain explorer that runs entirely in the browser tab. It reads from relays but trusts none of them: every operation it displays is re-verified client-side, with CIDs re-derived, signatures re-checked, and the chain re-folded, so what you see is what your own browser proved rather than what a relay asserted. The explorer is <a href="https://github.com/metalabel/dfos/tree/main/packages/dfos-explorer">MIT-licensed and in this repository</a>; it is deployed rather than published to npm.',
  },
  {
