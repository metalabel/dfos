...
@Test func jwsContentCreateVerification() {
    ...
    #expect(header["cid"] as? String == "bafyreia5z7zxknae5ds72euihuf2rg3ixl6t4fbzjefhcogg3nqppyogqu")
    #expect(payload["type"] as? String == "create")
}
