/**
 * Start a local TS relay with the optional content family disabled.
 * All adjacent relay capabilities retain their defaults.
 *
 * Usage: pnpm --filter @metalabel/dfos-web-relay exec tsx <path>/serve-content-disabled.ts [port]
 */
