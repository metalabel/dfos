/**
 * Start a local TS relay with the optional /revocations/v1 family disabled.
 * All adjacent relay capabilities retain their defaults.
 *
 * Usage: pnpm --filter @metalabel/dfos-web-relay exec tsx <path>/serve-revocations-disabled.ts [port]
 */
