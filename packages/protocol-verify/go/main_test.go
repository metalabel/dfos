...
func TestJWSContentCreateVerification(t *testing.T) {
	...
	if header["cid"] != "bafyreiaqatgdgwggufgy4tsz6eurwudtdxyguztt7nq5wgd7qi445nv56y" {
		t.Fatalf("wrong cid: %s", header["cid"])
	}
}
