...
check(
  'Delete header cid',
  result.header.cid === 'bafyreicl3a2t6vhz5vgvs5ojdw5wcwgoz3taxqqwexpbpltm2gh3q42zyi',
);
check(
...
check(
  'Restore header cid',
  result.header.cid === 'bafyreieyavue6vxzt63ulkqpwetfwqvfzdkeq6t3q3gwrjnqghmijrgyba',
);
check(
