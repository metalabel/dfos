...
@Test func jwsContentCreateVerification() {
    ...
    #expect(header["cid"] as? String == "bafyreiaqatgdgwggufgy4tsz6eurwudtdxyguztt7nq5wgd7qi445nv56y")
    #expect(payload["type"] as? String == "create")
}
